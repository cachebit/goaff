...
return [
    ...
    'Sorry, You account is banned.' => '对不起，您的账号已被禁用！<br>如有疑问，请联系 Affren QQ:3362259409',
    'All Categories' => '分类导航',
    ...
    'GitHub Name likes: somebody' => 'somebody',
    ...
    'Weibo Username example: somebody' => 'somebody',
    'Weibo ID example: 5963322692' => '用来拼接 URL 的，如：5963322692',
    'twitter_placeholder_hint' => 'somebody',
    ...
    'site_intro' => 'Affren.com 提供实时更新 Affiliate Marketing 和 Media Buy 国外干货翻译。',
    'contributing' => '欢迎提建议。',
    'be_nice' => '欢迎讨论相关问题和记录自己的成长之路。',
    ...
    'Congratulations and Welcome!' => '恭喜，欢迎加入 Affren 大家庭！',
    ...
    'Setup multiple Bindings allow you to login to the same account with different binding site account.' => '绑定多个第三方账号，允许你使用任意一个第三方账号登录同一个 Affren 账号。',
    ...
    'Bind Successfully!' => '绑定成功！以后可以使用你的 :driver 账号登录 Affren 了 ^_^',
    'Actived' => '最近访问',
];
